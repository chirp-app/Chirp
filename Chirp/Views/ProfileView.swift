...
//  Chirp
//
//  Created by Evan ORourke on 5/3/21.
//
...
//        table.backgroundColor = UIColor.white
    ...
    override init(frame: CGRect) {
        ...
        tableView.addSubview(createTableHeader()!)
...
//        tableView.register(createTableHeader(), forCellReuseIdentifier: "\(createTableHeader())")
//    }
    ...
    func createTableHeader() -> UIView? {
        ...
        let imageView = UIImageView(frame: CGRect(x: (self.frame.width - 150)/2,
                                        y:75,
                                        width: 150,
                                        height: 150))
